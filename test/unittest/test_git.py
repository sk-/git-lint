...
class GitTest(unittest.TestCase):
    ...
    def test_modified_files(self):
        ...
        with mock.patch(
                'subprocess.check_output', return_value=output) as git_call:
            self.assertEqual({
            ...
            self.assertEqual(
                {
                    ...
                    '/home/user/repo/test/e2etest/data/rubylint/error.rb':
                    'A ',
